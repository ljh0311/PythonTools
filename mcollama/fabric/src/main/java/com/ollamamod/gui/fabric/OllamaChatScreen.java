...
public class OllamaChatScreen extends Screen {
    ...
    private void sendMessage() {
        ...
        OllamaModFabric.getChatHandler().getOllamaClient().sendMessage(message, playerName)
            .thenAccept(response -> {
    ...
    private void clearChat() {
        String playerName = minecraft.player != null ? 
            minecraft.player.getName().getString() : "Player";
        OllamaModFabric.getChatHandler().getConversationManager().clearSession(playerName);
