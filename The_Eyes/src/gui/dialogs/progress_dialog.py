"""
Progress Dialog for the Clinic Data Visualizer application.

This module provides a progress dialog that shows the progress of long-running
operations like visualization generation, with support for cancellation.
...
- Throttled updates to prevent constant UI refreshes
- Optimized ETA calculation with reduced frequency
- Efficient watchdog timer

Performance improvements:
- Provides user feedback during long operations
- Allows cancellation of expensive operations
- Prevents user confusion during processing
- Ensures dialog is always responsive
...
class ProgressDialog:
    ...
    def __init__(self, parent, title: str = "Processing...", 
        ...
        Usage:
            dialog = ProgressDialog(parent_window, "Loading Data", "Processing files...")
