"""
Splash screen dialog for the Clinic Data Visualizer application.
...
class SplashScreen:
    ...
    APP_TITLE = "Clinic Data Visualizer"
    APP_TAGLINE = "Advanced Healthcare Analytics"
