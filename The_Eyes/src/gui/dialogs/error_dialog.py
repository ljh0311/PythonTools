"""
Error dialog for displaying application errors in a user-friendly way.

This module provides a comprehensive error dialog that shows error details,
stack traces, and recovery options to help users understand and resolve issues.
"""
