...
class Camera3D:
    ...
    def update(self, keys_pressed, mouse_delta: Tuple[int, int]):
...
class World3D:
    ...
    def __init__(self, width: int = 800, height: int = 600):
        ...
        # Initialize OpenGL (after lighting is defined)
        self._setup_opengl()
    ...
    def _setup_opengl(self):
        ...
        gl.glClearColor(0.2, 0.3, 0.3, 1.0)  # Dark cyan background
    ...
    def render(self):
        ...
        target_pos = self.camera.target
        glu.gluLookAt(
            camera_pos[0], camera_pos[1], camera_pos[2],  # Camera position
            target_pos[0], target_pos[1], target_pos[2],  # Look at point
            0, 1, 0  # Up vector
        )
